    ...
    <p className="mx-8 lg:mx-[48px] text-[15px] mt-1 font-semibold">Hasta 20 productos y 4 secciones estos son los precios base:</p>
        ...
        md:flex md:flex-wrap md:justify-evenly md:my-[80px] my-[40px]">
            {/*Básico */}
             ...
             $<span className="price-integer">40.000</span>
             </p>
             </div>
     ...
     {/*Estándar */}
             ...
             <div className="price-value" data-currency="$ USD" data-currency-simple="USD">
             <p className="price-number">
             $<span className="price-integer">60.000</span>
             </p>
             </div>
     ...
     {/*Premium */}
        ...
        <h2 className="mx-8 lg:mx-[48px] text-[18px] font-bold text-[#977c4b] opacity-[50%] mt-[60px]"> - Planes para profesionales -</h2>
        <p className="mx-8 lg:mx-[48px] text-[18px] mt-3">Los planes para profesionales son apropiados para aquellos que procuran su presencia online y/o quieren facilitar algún aspecto de su negocio mediante implementaciones de automatización o marketing.</p>
     ...
     {/*BÁSICO */}
             ...
             style={{
                ...
                } className="card mb-[30px] md:my-0">

             <div className="pricing-block-content">
             <p className="pricing-plan">PROFESINAL BÁSICO</p>
             <div className="price-value" data-currency="$ USD" data-currency-simple="USD">
             <p className="price-number">
             $<span className="price-integer">50.000</span>
             </p>
             
             </div>
             <div className="pricing-note">Mantenimiento $0</div>
             <ul className="check-list" role="list">
             <li className="check-list-item">
             <svg
              version="1.0"
            ...
            Busqueda y configuración de dominio
          </li>
          <li className="check-list-item">
          <svg
              version="1.0"
     ...
     {/*ESTÁNDAR */}
             ...
             <div className="price-value" data-currency="$ USD" data-currency-simple="USD">
             <p className="price-number">
             $<span className="price-integer">90.000</span>

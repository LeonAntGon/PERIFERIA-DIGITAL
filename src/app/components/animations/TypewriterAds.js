...
const ExampleUsageTypingMachine = () => {
  return (
      <div className="min-h-10 flex flex-col items-center justify-center text-center mt-2">
        <TypingMachine text="Anuncios en Redes Sociales" speed={70} fontSize="text-xl" color="text-gray-200" fontStyle="" />
      </div>
  );
};

function TypewriterAds() {
  return (
    <>
